    ...
    case WM_KEYDOWN:
        {
            ...
            Event* pEvent = new InputEvent( InputDeviceType_Keyboard, InputState_Pressed, wParam, vec2(0,0) );
    ...
    case WM_KEYUP:
        {
            ...
            Event* pEvent = new InputEvent( InputDeviceType_Keyboard, InputState_Released, wParam, vec2((float)0,(float)0) );
            pFramework->GetGameCore()->GetEventManager()->QueueEvent( pEvent );
        }
        return 0;
    ...
    case WM_MOUSEMOVE:
        {
            ...
            Event* pEvent = new InputEvent(InputDeviceType_Mouse, InputState_MouseMove, (float)wParam, vec2((float)x,(float) y));
            pFramework->GetGameCore()->GetEventManager()->QueueEvent(pEvent);
        }
        return 0;
